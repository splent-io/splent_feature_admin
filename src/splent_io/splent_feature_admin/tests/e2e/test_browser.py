"""
End-to-end tests for splent_feature_admin.
...
Run with:  splent feature:test splent_feature_admin --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_admin")
    assert "splent_feature_admin" in browser.page_source.lower()
